...
class DriverVersionHandler {
    ...
    void writeVersionFile(Driver driver) throws MojoExecutionException {
        ...
        try {
            ...
            throw new MojoExecutionException("Failed to create version file containing metadata about the installed driver" + System.lineSeparator() + "driver: " + driver, e);
        }
    }
    ...
    public boolean isSameVersion(Driver driver) throws MojoExecutionException {
        try {
            ...
            throw new MojoExecutionException("Failed to compare installed driver version with the driver version to install" + System.lineSeparator() + "driver: " + driver, e);
        }
    }
}
